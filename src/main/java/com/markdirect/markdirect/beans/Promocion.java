...
public class Promocion {
	...
	/**
	 * M�todo para generar el c�digo Json con los datos de las promociones
	 * @param promoList: List con los datos de la promoci�n
	 * @return ofertas: ArrayList con los datos de la promoci�n en lenguaje Json
	 */

...
public class DatabaseMarkDirect extends DatabaseGenerica {
	...
	/**
	 * M�todo para editar y modificar las promociones de la base de datos
	 * Todos estos par�metros son los atributos de la promoci�n
	 * @param promoId
	 * @param promoName
	 * @param promoDescription
	 * @param promoSince
	...
	/**
	 * M�todo para eliminar una promoci�n de la base de datos
	 * @param promoId : se elimina a partir de la id de la promoci�n

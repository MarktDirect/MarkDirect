...
public class LoginController {
	 ...
	 * @param usuario
	 * @param password
	 * @return devuelve un mav con la pagina que visitar y le aÒade un metodo para comprobar usuario
	 * ademas tambien devuelve atributos aÒadidos a la sesion y crea la sesion del usuario
	 */
	...
	public ModelAndView validar(
		...
		//Atributos a√±adidos a la sesi√≥n para cargar datos de estad√≠sticas
